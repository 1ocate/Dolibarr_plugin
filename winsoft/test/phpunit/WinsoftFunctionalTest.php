...
/**
 * \file    test/phpunit/WinsoftFunctionalTest.php
 * \ingroup winsoft
 ...
 * @package Testwinsoft
 */
class WinsoftFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/winsoft/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('winsoft/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/winsoft/admin/about.php');
		$this->authenticate();
		return $this->assertContains('winsoft/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('winsoftwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modWinsoft_WinsoftTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modWinsoft_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
